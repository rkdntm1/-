...
--배달
-- id, reg_dt, upt_dt, status, member_id, store_id, order_contents, req_end_lat, req_end_lng, req_end_addr, req_delivery_tip, req_cooked_time, req_id, rider_id
create table b_delivery(
	...
	status					varchar2(15),   		-- 요청, 수행, 배달중,  배달완료, 취소 ,(예외)
