...
public interface ReplyMapper {
	//LRCUD
	/** -------------- 게시글 처리 함수 정의 영역  --------------------- */
	public long getTotalCount(@Param("boardId") String boardId, @Param("descrim") String descrim);
	public long getSearchTotalCount(@Param("boardId") String boardId, @Param("cri") Criteria cri);
	...
	public List<PostVO> getList(@Param("boardId") String boardId, @Param("cri") Criteria cri);
	public List<PostVO> getListByHashTag(@Param("boardId") String boardId, @Param("cri") Criteria cri);
	/** hashTag 검색 개인화 */
	public List<PostVO> getFavorite(@Param("boardId") String boardId, @Param("curUser") Party curUser);
