			...
			<div class="container">
				<div class="form">
					...
					<form method="post" action="/party/joinMember">
						...
						<c:forEach items="${getLocTypeList}" var="locationType" varStatus="status">
							<label>${locationType.description}</label><br>
							<input type="hidden" name="listlocation[${status.index}].locationType" value="${locationType.locationType}" readonly> 
							<input id="location${status.index}" name="listLocation[${status.index}].info" readonly><br>
						</c:forEach>
						...
						<input type="hidden" name = "descrim" value="${partyType}">
