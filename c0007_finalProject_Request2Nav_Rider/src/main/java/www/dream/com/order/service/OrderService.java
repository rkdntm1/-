...
//	}
	...
	public List<DetailOrder> getDetailOrderList() {
		return orderMapper.getDetailOrderList();
	}

	public int insertOrder(String memberId, OrderList orderList, DetailOrder detailOrder) {
		return orderMapper.insertOrder(memberId, orderList, detailOrder);
	}
