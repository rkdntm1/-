...
insert into b_location(id, user_id,latitude, longitude)
	values('00001', 'store0', 37.484015, 126.928856);
insert into b_location(id, user_id,latitude, longitude)
	values('00002', 'store1', 37.480380, 126.877203);
insert into b_location(id, user_id,latitude, longitude)
	values('00003', 'store2',37.4803199,126.8779695);
insert into b_location(id, user_id,latitude, longitude)
	values('00004', 'store3', 37.480744, 126.880937);
