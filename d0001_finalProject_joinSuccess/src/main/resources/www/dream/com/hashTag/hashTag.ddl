...
drop SEQUENCE bseq_hashtag_id;

CREATE SEQUENCE bseq_hashtag_id;

--	id, super_id, hashtag, description
create table b_hashtag(
	id				number(9) primary key,
	super_id		number(9) references b_hashtag(id), 
...
BEGIN
	FOR i in 1..cnt LOOP
		select bseq_hashtag_id.nextval into seq_val from dual;
