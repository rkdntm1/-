...
public class ReplyMapperTest4Post {
	...
	public void test000InsertPost() {
		try {
			...
			PostVO post = new PostVO("아름다운 강산", "제3공화국 시절, 지금은 한국 록의 대부로 일컬어지는 신중현에게 당시 정권이었던 박정희를 찬양하는 노래를 만들라고 꾸준히 강요했다", new Rider("rkdntm1"));
			post.setLocation("서울시 강남구 가산디지털단지역");
