			...
			<div class="container">
				<div class="form">
					...
					<form method="post" action="/party/joinMember">
						...
						<c:forEach items="${listLocType}" var="locationType" varStatus="status">
							<input type="hidden" name="listLocation[${status.index}].locationType" value="${locationType.locationType}">
							<input type=ㅋ"hidden" id="loc${status.index}" name="listLocation[${status.index}].info" value="">
						</c:forEach>
					</form>
				</div>		
			</div>
...
$(document).ready(function(){
	...
	$("#userId").on("focusout", function(){
		...
		$.ajax({	
		    url: '/party/chkIdDup?newBieId=' + newBieId,
		    type: 'get',
