...
public class DeliveryRequestVO extends DeliveryVO{
	...
	public DeliveryRequestVO(String memberId, String storeId, String orderContents, double endLat,
			double endLng, String endAddr, String deliveryTip, String cookedTime) {
