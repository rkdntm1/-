...
public class PostController {
	...
	public void listPostBySearch(@RequestParam("boardId") String boardId,
		...
		model.addAttribute("boardName", boardService.getCategory(boardId).getName());
	...
	public String modifyPost(@RequestParam("boardId") String boardId, PostVO modifiedPost, 
	...
	@PreAuthorize("principal.username == #writerId")
	public String removePost(@RequestParam("boardId") String boardId, Criteria fromUser,
